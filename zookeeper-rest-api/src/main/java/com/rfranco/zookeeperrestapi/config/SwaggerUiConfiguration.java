...
@Configuration
@ComponentScan(basePackages = "com.rfranco.zookeeperrestapi.autogenerated.api")
@EnableWebMvc
...
public class SwaggerUiConfiguration extends WebMvcConfigurerAdapter {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        if (!registry.hasMappingForPattern("/nodes/**")) {
            registry.addResourceHandler("/nodes/**").addResourceLocations(RESOURCE_LOCATIONS);
        }
