...
import com.rfranco.zookeeperrestapi.autogenerated.dtos.ErrorMessage;
...
public interface NodesApi {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Bad request. The request is not a well-formed request or it is missing some required parameters. An error message is returned indicating the nature of the error.", response = ErrorMessage.class),
    ...
    ResponseEntity<Void> addNodeChild(@ApiParam(value = "The path of the node that will be added a child (with ~ instead of /).",required=true ) @PathVariable("nodePath") String nodePath,@ApiParam(value = "The data of the new node (name and value)."  )  @Valid @RequestBody NodeCreationRequest body);
    ...
    ResponseEntity<Void> deleteNode(@ApiParam(value = "The path of the node whose data will be deleted  (with ~ instead of /).",required=true ) @PathVariable("nodePath") String nodePath);
    ...
    ResponseEntity<ChildrenNodes> getNodeChildren(@ApiParam(value = "The path of the node whose children will be retrieved (with ~ instead of /).",required=true ) @PathVariable("nodePath") String nodePath);
    ...
    @RequestMapping(value = "/nodes/{nodePath}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<NodeData> getNodeData(@ApiParam(value = "The path of the node whose data will be retrieved  (with ~ instead of /).",required=true ) @PathVariable("nodePath") String nodePath);
    ...
    @RequestMapping(value = "/nodes/{nodePath}/export",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<NodeExport> getNodeExport(@ApiParam(value = "The path of the node whose data will be exported (with ~ instead of /).",required=true ) @PathVariable("nodePath") String nodePath);
    ...
    ResponseEntity<Void> restoreNodeExport(@ApiParam(value = "The path of the node whose data will be restored (with ~ instead of /).",required=true ) @PathVariable("nodePath") String nodePath,@ApiParam(value = "Indicates whether the import should prune nodes existing in ZooKeeper that do not exist in the export. The default is `false`.", defaultValue = "false") @RequestParam(value = "prune", required = false, defaultValue="false") Boolean prune,@ApiParam(value = "Indicates whether the value of already existing nodes should be overwritten. The default is `true`.", defaultValue = "true") @RequestParam(value = "overwrite", required = false, defaultValue="true") Boolean overwrite,@ApiParam(value = "The node export that will be restored into the specified path."  )  @Valid @RequestBody NodeExport node);
    ...
    @RequestMapping(value = "/nodes/{nodePath}",
        produces = { "application/json" }, 
        method = RequestMethod.PUT)
    ResponseEntity<Void> setNodeData(@ApiParam(value = "The path of the node whose data will be set  (with ~ instead of /).",required=true ) @PathVariable("nodePath") String nodePath,@ApiParam(value = "The data to set to the given node."  )  @Valid @RequestBody NodeData nodeData);
